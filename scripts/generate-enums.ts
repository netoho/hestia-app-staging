...
async function main() {
  try {
    console.log('🔍 Extracting enums from Prisma client...');
    const enums = extractEnums();

    console.log(`📦 Found ${Object.keys(enums).length} enums:`, Object.keys(enums).join(', '));
    ...
    console.log('✅ Successfully generated client-safe enums!');
