...
export const home = {
    ...
    testimonials: [
        { id: 't1', name: 'Claudia Morán', role: 'Asesor Inmobiliario', quote: "La protección jurídica HESTIA ofrece un servicio confiable, profesional y eficiente. La atención es clara y oportuna, con asesoría legal bien fundamentada y un acompañamiento constante. Brinda seguridad y tranquilidad al saber que se cuenta con un respaldo jurídico serio y comprometido. Muy recomendable.", avatarUrl: '/images/testimonials/claudia.png', dataAiHint: 'man smiling' },
