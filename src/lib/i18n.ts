...
const es = {
    ...
    pages: {
        ...
        privacy: {
            ...
            intro1: (companyName: string, siteName: string) => `${companyName} ("nosotros", "nuestro") opera el sitio web ${siteName} (el "Servicio").`,
            intro2: "Esta página le informa de nuestras políticas sobre la recopilación, uso y divulgación de datos personales cuando utiliza nuestro Servicio y las opciones que tiene asociadas a esos datos.",
            intro3: "Utilizamos sus datos para proporcionar y mejorar el Servicio. Al utilizar el Servicio, usted acepta la recopilación y el uso de información de acuerdo con esta política.",
            collectionTitle: "Recopilación y Uso de Información",
            collectionText: "Recopilamos varios tipos diferentes de información para diversos fines para proporcionar y mejorar nuestro Servicio para usted.",
            typesOfData: "Tipos de Datos Recopilados",
            personalData: "Datos Personales",
            personalDataText: `Mientras utiliza nuestro Servicio, podemos pedirle que nos proporcione cierta información de identificación personal que se puede utilizar para contactarlo o identificarlo ("Datos Personales"). La información de identificación personal puede incluir, entre otros:`,
            personalDataList: ["Dirección de correo electrónico", "Nombre y apellido", "Número de teléfono", "Dirección, Estado, Provincia, Código Postal, Ciudad", "Cookies y Datos de Uso"],
            usageData: "Datos de Uso",
            usageDataText: `También podemos recopilar información sobre cómo se accede y utiliza el Servicio ("Datos de Uso"). Estos Datos de Uso pueden incluir información como la dirección de Protocolo de Internet de su computadora (por ejemplo, dirección IP), tipo de navegador, versión del navegador, las páginas de nuestro Servicio que visita, la hora y fecha de su visita, el tiempo que pasó en esas páginas, identificadores únicos de dispositivos y otros datos de diagnóstico.`,
            useOfDataTitle: "Uso de los Datos",
            useOfDataText: (companyName: string) => `${companyName} utiliza los datos recopilados para diversos fines:`,
            useOfDataList: ["Para proporcionar y mantener el Servicio", "Para notificarle sobre cambios en nuestro Servicio", "Para permitirle participar en funciones interactivas de nuestro Servicio cuando decida hacerlo", "Para proporcionar atención y soporte al cliente", "Para proporcionar análisis o información valiosa para que podamos mejorar el Servicio", "Para monitorear el uso del Servicio", "Para detectar, prevenir y abordar problemas técnicos"],
            securityTitle: "Seguridad de los Datos",
            securityText: "La seguridad de sus datos es importante para nosotros, pero recuerde que ningún método de transmisión por Internet o método de almacenamiento electrónico es 100% seguro. Si bien nos esforzamos por utilizar medios comercialmente aceptables para proteger sus Datos Personales, no podemos garantizar su seguridad absoluta.",
            changesTitle: "Cambios a esta Política de Privacidad",
            changesText1: "Podemos actualizar nuestra Política de Privacidad de vez en cuando. Le notificaremos cualquier cambio publicando la nueva Política de Privacidad en esta página.",
            changesText2: `Se lo haremos saber por correo electrónico y/o un aviso destacado en nuestro Servicio, antes de que el cambio entre en vigencia y actualizaremos la "fecha de vigencia" en la parte superior de esta Política de Privacidad.`,
            changesText3: "Se le recomienda que revise esta Política de Privacidad periódicamente para detectar cualquier cambio. Los cambios a esta Política de Privacidad son efectivos cuando se publican en esta página.",
            contactTitle: "Contáctenos",
            contactText: "Si tiene alguna pregunta sobre esta Política de Privacidad, contáctenos:",
            contactList: (email: string) => [`Por correo electrónico: ${email}`],
        },
        terms: {
