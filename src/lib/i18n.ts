    ...
    pages: {
        ...
        home: {
            ...
            testimonials: [
                ...
                { id: 't2', name: 'Karim Goudiaby', role: 'Asesor Inmobiliario', quote: "Siempre recomiendo a mis clientes usar Hestia. Simplifica las negociaciones y proporciona una protección robusta, beneficiando a todos los involucrados.", avatarUrl: '/images/testimonials/karim.png', dataAiHint: 'professional woman' },
            ] as Testimonial[],
            howItWorksSteps: [
