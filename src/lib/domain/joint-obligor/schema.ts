...
export const jointObligorPersonalIndividualTabSchema = personWithNationalitySchema
...
export const jointObligorPersonalCompanyTabSchema = companyWithLegalRepSchema
  .merge(extendedContactSchema)
  .extend({
...
export const jointObligorEmploymentTabSchema = z.object({
...
export const guaranteeBaseSchema = z.object({
...
export const incomeGuaranteeSchema = guaranteeBaseSchema.extend({
...
export const propertyGuaranteeSchema = guaranteeBaseSchema.extend({
...
export const jointObligorReferencesIndividualTabSchema = z.object({
...
export const jointObligorReferencesCompanyTabSchema = z.object({
...
export const jointObligorDocumentsTabSchema = z.object({
