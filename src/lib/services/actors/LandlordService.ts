...
export class LandlordService extends BaseActorService<LandlordWithRelations, LandlordData> {
  ...
  async savePropertyDetails(
    ...
    const savedDetails: PropertyDetailsType = {
      ...
      electricityIncludedInRent: result.value.electricityIncludedInRent,
      waterIncludedInRent: result.value.waterIncludedInRent,
      gasIncludedInRent: result.value.gasIncludedInRent,
      internetIncludedInRent: result.value.internetIncludedInRent,
      cableTVIncludedInRent: result.value.cableTVIncludedInRent,
      phoneIncludedInRent: result.value.phoneIncludedInRent,
