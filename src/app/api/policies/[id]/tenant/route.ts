    ...
    if (policy.tenant) {
      ...
      tenant = await prisma.tenant.update({
        ...
        data: {
          ...
          paternalLastName: tenantData.paternalLastName || null,
          maternalLastName: tenantData.maternalLastName || null,
          ...
          legalRepFirstName: tenantData.legalRepFirstName || null,
          legalRepMiddleName: tenantData.legalRepMiddleName || null,
          legalRepPaternalLastName: tenantData.legalRepPaternalLastName || null,
          legalRepMaternalLastName: tenantData.legalRepMaternalLastName || null,
