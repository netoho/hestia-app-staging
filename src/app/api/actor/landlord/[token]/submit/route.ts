...
const companyLandlordSchema = z.object({
  ...
  legalRepRfc: z.string().min(12).max(13).optional(),
...
const propertyDetailsSchema = z.object({
  ...
  parkingNumbers: z.string().optional(), // JSON array
  ...
  otherServices: z.string().optional(), // JSON array
  ...
  rentIncreasePercentage: z.number().min(0).max(100).optional(),
  ...
  contractSigningLocation: z.string().optional(),
  propertyAddressDetails: addressSchema.optional(),
});
