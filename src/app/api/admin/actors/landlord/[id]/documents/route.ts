/**
 * Admin endpoint for landlord document management
  ...
  try {
    ...
    await prisma.policyActivity.create({
      data: {
        ...
        description: `Admin uploaded ${documentType} document for landlord`,
...
export async function GET(
  ...
  try {
    ...
    const formattedDocuments = landlord.documents.map(doc => ({
      id: doc.id,
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        totalCount: landlord.documents.length,
      },
    });
  } catch (error) {
  ...
  try {
    ...
    await prisma.policyActivity.create({
      data: {
        ...
        description: `Admin deleted landlord document`,
        performedById: userId,
        details: {
          documentId,
