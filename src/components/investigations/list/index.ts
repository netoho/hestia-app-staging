export { default as InvestigationsHeader } from './InvestigationsHeader';
export { default as InvestigationsFilters } from './InvestigationsFilters';
export { default as InvestigationsList } from './InvestigationsList';
export { default as InvestigationsTable } from './InvestigationsTable';
