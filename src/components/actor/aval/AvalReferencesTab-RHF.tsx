          ...
          <Card>
            <CardHeader>
              ...
              <p className="text-sm text-muted-foreground">
                Proporcione exactamente 3 referencias personales que no sean familiares
              </p>
            </CardHeader>
            <CardContent>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input {...field} placeholder="10 dígitos" maxLength={10} disabled={disabled} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input {...field} placeholder="Ej: Amigo, Colega" disabled={disabled} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input {...field} placeholder="Nombre de la empresa" disabled={disabled} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input {...field} placeholder="Ej: Proveedor, Cliente" disabled={disabled} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
